...
graph TD
    ...
    node0 --> node1
    node2["student_feedback.csv"]
    node0 --> node2
    node3["student_feedback_with_comments.csv"]
    node0 --> node3
    node4["student_feedback_with_sentiment.csv"]
    node0 --> node4
    node5["README.md"]
    node0 --> node5
    node6["generate_diagrams.py"]
    node1 --> node6
    node7["repo_analyzer.py"]
    node1 --> node7
    node8["ai_doc_agent.py"]
    node1 --> node8
    classDef folder fill:#e1f5fe,stroke:#01579b,stroke-width:2px;
    click node1 "scripts" "View scripts"
    click node2 "student_feedback.csv" "View student_feedback.csv"
    click node3 "student_feedback_with_comments.csv" "View student_feedback_with_comments.csv"
    click node4 "student_feedback_with_sentiment.csv" "View student_feedback_with_sentiment.csv"
    click node5 "README.md" "View README.md"
    click node6 "scripts/generate_diagrams.py" "View generate_diagrams.py"
    click node7 "scripts/repo_analyzer.py" "View repo_analyzer.py"
    click node8 "scripts/ai_doc_agent.py" "View ai_doc_agent.py"
```
<!-- DIAGRAMS_END -->
